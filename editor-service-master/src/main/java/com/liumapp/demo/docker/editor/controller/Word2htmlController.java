...
public class Word2htmlController {
    ...
    public String parseDocToHtml(@RequestParam("file") MultipartFile file) throws IOException, ParserConfigurationException, TransformerException {
        ...
        if ("docx".equals(suffix)) return parseDocxToHtml(fileName);
...
//                    new FileURIResolver(imageFolderFile));
            ...
            options.URIResolver(new BasicURIResolver(path));
...
//            OutputStream baos = new FileOutputStream(new File(
//                    path, "result.html"));
...
//            content = Pattern.compile("img src=\"").matcher(content).replaceAll("img src=\"" + "https://localhost:8081");
